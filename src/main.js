...
const state = {
  ...
  focus: "all",
  selectedServiceId: "",
  theme: localStorage.getItem("homelab-theme") || "light",
  roadmapItems: [],
  roadmapLoaded: false,
  roadmapError: "",
  savingRoadmap: false,
